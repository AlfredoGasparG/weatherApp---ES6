...
const APP_ID ='dc84c0f66247c3baef0fe14ad85ab637'

ELEMENTS.ELEMENT_BUTTON_SEARCH.addEventListener('click',searchWeather)

function searchWeather(){
    const CITY_NAME = ELEMENTS.ELEMENT_CITY_TO_SEARCH.value.trim();
